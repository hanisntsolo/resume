...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% \section{Platform}
{\href{https://github.com/Citi-Rippler}{\subsection{Rippler}}}
\href{https://docs-rippler.hanisntsolo.dev/docs/architecture}{\location{AI Powered - Code Impact Analysis Platform : Click Me}}
...
% \vspace{\topsep}
\begin{tightemize}
\item Developed a scalable automated incident processor(\textbf{800 lines of TACL} \textit{Tandem Advanced Command Language} used in DebitCard/Credit Card Txns) for \includesvg[width=0.1\textwidth]{assets/discover-network.svg} Discover Financial Services, \textbf{auto-closing 98\% of incidents}, cutting dwell time to net zero.
